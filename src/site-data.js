...
export const site = {
  ...
  //
  // Os marcadores {telefone} e {endereco} sao substituidos no build pelos dados
  // de `business`, para a politica nunca divergir do NAP.
  privacy: {
    title: 'Política de Privacidade',
    summary:
      'Este site é uma página informativa. Ele não possui formulários, não solicita dados pessoais e não registra nenhuma informação de saúde.',
    updated: '2026-09-05',
    sections: [
      {
        title: 'Quem é o controlador dos dados',
        paragraphs: [
          'Claudia Estela Maciel Davalos (Dra. Claudia Maciel), CRM/MS 5944, com consultório na {endereco}. Contato para assuntos de privacidade: {telefone} (também WhatsApp).',
        ],
      },
      {
        ...
        paragraphs: [
          ...
          'Se — e somente se — você autorizar no aviso de cookies, o Google Analytics 4 registra dados de navegação de forma agregada: páginas e seções visitadas, tempo de permanência, tipo de dispositivo, navegador, sistema operacional, origem do acesso (por exemplo, uma busca no Google) e localização aproximada em nível de cidade, derivada do endereço IP. O endereço IP é anonimizado pelo próprio Google e não é armazenado.',
      ...
      },
      {
        title: 'Cookies',
        paragraphs: [
          'Antes da sua autorização, nenhum cookie de análise é gravado e o script do Google Analytics sequer é carregado.',
          'Ao registrar sua escolha no aviso de cookies, o site guarda apenas essa preferência no seu próprio navegador (armazenamento local), para não perguntar de novo a cada visita. Essa preferência não é enviada a ninguém.',
          'Se você aceitar, o Google Analytics grava cookies próprios (_ga e _ga_*) para distinguir visitas. Você pode revogar a autorização a qualquer momento limpando os dados do site no seu navegador.',
        ],
      },
      {
        title: 'Base legal e finalidade',
        paragraphs: [
          'O tratamento dos dados de navegação tem como base legal o seu consentimento (art. 7º, I, da Lei 13.709/2018 — LGPD) e como única finalidade entender como o site é usado, para melhorá-lo. Os dados não são usados para publicidade, não são vendidos e não são compartilhados com terceiros além do próprio Google, na condição de operador.',
        ],
      },
      {
        title: 'Por quanto tempo os dados ficam guardados',
        paragraphs: [
          'Os dados de navegação são retidos pelo Google Analytics por até 14 meses e depois excluídos automaticamente. A preferência de cookies fica no seu navegador até você limpá-la.',
        ],
      },
      {
        ...
        paragraphs: [
          ...
          'A conversa de agendamento acontece dentro do WhatsApp. Evite enviar por lá informações detalhadas sobre sua saúde: esses assuntos são tratados na consulta.',
        ],
      },
      {
        title: 'Seus direitos',
        paragraphs: [
          'A LGPD (art. 18) garante a você, entre outros, o direito de confirmar a existência de tratamento, acessar seus dados, corrigi-los, solicitar a eliminação dos dados tratados com base no consentimento e revogar o consentimento a qualquer momento. Para exercer qualquer um deles, entre em contato pelo {telefone}.',
        ],
      },
      {
        title: 'Alterações desta política',
        paragraphs: [
          'Esta política pode ser atualizada quando o site mudar. A data da última atualização fica indicada no início desta seção.',
        ],
      },
    ],
  },
